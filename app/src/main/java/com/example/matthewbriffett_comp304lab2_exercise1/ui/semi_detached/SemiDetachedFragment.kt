package com.example.matthewbriffett_comp304lab2_exercise1.ui.semi_detached
...
import com.example.matthewbriffett_comp304lab2_exercise1.databinding.FragmentSemiDetachedBinding
import com.google.android.material.floatingactionbutton.FloatingActionButton


class SemiDetachedFragment : Fragment() {
    private var _binding: FragmentSemiDetachedBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSemiDetachedBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val myDataset = DataSource().loadSemiDetachedHomes()

        //get RecyclerView and set data binding to appropriate recycler
        val recyclerView: RecyclerView = binding.semiDetachedRecycler
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            val action = SemiDetachedFragmentDirections.actionSemiDetachedFragmentToSelectedHomeFragment()
