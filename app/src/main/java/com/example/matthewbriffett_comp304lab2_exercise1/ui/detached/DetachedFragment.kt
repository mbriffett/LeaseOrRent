package com.example.matthewbriffett_comp304lab2_exercise1.ui.detached
...
import com.example.matthewbriffett_comp304lab2_exercise1.databinding.FragmentDetachedBinding
import com.google.android.material.floatingactionbutton.FloatingActionButton


class DetachedFragment : Fragment() {
    private val viewModel: SharedViewModel by activityViewModels()
    private var _binding: FragmentDetachedBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDetachedBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val myDataset = DataSource().loadDetachedHomes()

        //get RecyclerView and set data binding to appropriate recycler
        val recyclerView: RecyclerView = binding.detachedRecycler
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            val action = DetachedFragmentDirections.actionDetachedFragmentToSelectedHomeFragment()
