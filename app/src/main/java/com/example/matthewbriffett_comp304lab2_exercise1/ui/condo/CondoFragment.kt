package com.example.matthewbriffett_comp304lab2_exercise1.ui.condo
...
import com.example.matthewbriffett_comp304lab2_exercise1.databinding.FragmentCondoBinding
import com.google.android.material.floatingactionbutton.FloatingActionButton

class CondoFragment : Fragment() {
    private val viewModel: SharedViewModel by activityViewModels()
    private var _binding: FragmentCondoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCondoBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val myDataset = DataSource().loadCondos()
        //create RecyclerView and set data binding to appropriate recycler
        val recyclerView: RecyclerView = binding.condoRecycler
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            val action = CondoFragmentDirections.actionCondoFragmentToSelectedHomeFragment()
